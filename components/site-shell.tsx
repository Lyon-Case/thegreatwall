...
export function SiteHeader() {
  ...
  return <>
    <header className="site-header">
      <Link href="/" className="wordmark" onClick={() => setOpen(false)}><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ChatGPT%20Image%20Sep%2010%2C%202026%2C%2002_28_27%20PM-PH4h09O67nUWonM6STDTRYSQMaaQ1X.png" alt="The Great Wall" /></Link>
...
export function SiteFooter() {
  return <footer className="footer"><div className="footer-intro"><Link href="/" className="footer-brand"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ChatGPT%20Image%20Sep%2010%2C%202026%2C%2002_28_27%20PM-PH4h09O67nUWonM6STDTRYSQMaaQ1X.png" alt="The Great Wall" /><span>THE GREAT WALL</span></Link><p>Culture, connection and good times in Gaborone.</p></div><div className="footer-services"><span>What we do</span><Link href="/eat-drink">Dining & cocktails</Link><Link href="/whats-on">Live events</Link><Link href="/reservations">Private reservations</Link><Link href="/venue">Venue hire</Link><Link href="/gallery">Creative gatherings</Link></div><div className="footer-links"><span>Stay connected</span><Link href="/contact">Contact</Link><Link href="/gallery">Instagram</Link><Link href="/tickets">Tickets</Link></div><span className="footer-code">© 2026 / TGW_BW</span></footer>
}
